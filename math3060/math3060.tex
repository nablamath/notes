...
\begin{thm}
  ...
  \prtc[b]{zr} Choose $r>0$ as in Part (a), then for all $y\in B_{r/2}(0)$, there exists $x\in B_{r}(0)$ such that $F(x)=y$. This is true because of Perturbation of Identity (\rthm[\sctr{6}]) with $\epsilon=1/2$. The local inverse $G$ of $F$,
